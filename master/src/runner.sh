...
go run exact.go kernel3.go f1.go -n $N -top $TOP > ../results/exact.2.0.$N.$TOP.log
go run exact.go kernel3.go f2.go -n $N -top $TOP > ../results/exact.2.1.$N.$TOP.log
go run exact.go kernel3.go f3.go -n $N -top $TOP > ../results/exact.2.2.$N.$TOP.log
cd ..
...
go run lubich.go kernel3.go f1.go -n $N -top $TOP > ../results/lubich.2.0.$N.$TOP.log
go run lubich.go kernel3.go f2.go -n $N -top $TOP > ../results/lubich.2.1.$N.$TOP.log
go run lubich.go kernel3.go f3.go -n $N -top $TOP > ../results/lubich.2.2.$N.$TOP.log
cd ..
...
go run rect.go kernel3.go f1.go -n $N -top $TOP > ../results/rect.2.0.$N.$TOP.log
go run rect.go kernel3.go f2.go -n $N -top $TOP > ../results/rect.2.1.$N.$TOP.log
go run rect.go kernel3.go f3.go -n $N -top $TOP > ../results/rect.2.2.$N.$TOP.log
cd ..
...
go run mid.go kernel3.go f1.go -n $N -top $TOP > ../results/mid.2.0.$N.$TOP.log
go run mid.go kernel3.go f2.go -n $N -top $TOP > ../results/mid.2.1.$N.$TOP.log
go run mid.go kernel3.go f3.go -n $N -top $TOP > ../results/mid.2.2.$N.$TOP.log
cd ..
